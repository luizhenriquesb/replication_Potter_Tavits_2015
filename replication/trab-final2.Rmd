...
Outra forma de analisar os outliers é através de uma análise gráfica dos resíduos pelas observações influentes. Aqui, é necessário primeiro rodar o modelo para depois plotar o gráfico. Assim, rodamos o modelo 1 que os autores apresentam na tabela 2 no artigo.
...
Também neste tipo de análise é primeiro rodar o modelo. Novamento utilizamos o modelo 1 da tabela2. Em uma análise dos resíduos padronizados, são considerados valores outliers aqueles cujos resíduos padronizados forem maior que 2 ou menor que -2. Nesta análise, os países considerados outliers foram `r paste(paises_outliers, sep = ", ")`.
...
stargazer::stargazer(components,
  type = "latex",
  style = "ajps",
  title = "Modelo da nota de rodapé 42",
  single.row = TRUE,
  keep.stat = c("n", "rsq"),
  dep.var.labels = "Competição partidária",
  header = FALSE,
...
### 3. Controlando pelo limiar eleitoral legal

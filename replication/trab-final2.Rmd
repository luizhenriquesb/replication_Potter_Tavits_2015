...
```{r message=FALSE, warning=FALSE, fig.align='center', fig.width=3, fig.height=4, out.width="30%", out.height="40%"}
raw_data |>
  ggplot() +
  aes(y = postenp) +
...
```{r, fig.align='center', fig.height=4, fig.width=6, out.height="40%", out.width="60%"}
...
```{r, fig.align='center', fig.height=4, fig.width=6, out.height="40%", out.width="60%", warning=FALSE}
raw_data |> 
  ggplot() +
